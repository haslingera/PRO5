...
public class Initiate : MonoBehaviour {
	...
	void Start () {
		if (Application.loadedLevelName.Equals ("Road_Scene")) {
			UIBehaviour.Instance.CameraStartRotation (new Vector3 (0f, -90f, 0f)).CameraStartSize (0.01f).LevelStart ();
			...
			UIBehaviour.Instance.CameraStartRotation (new Vector3 (90f, 0f, 0f)).CameraStartSize (0.01f).LevelStart ();
		} else if (Application.loadedLevelName.Equals ("Tod-Szene-Spiel")) {
			UIBehaviour.Instance.CameraStartRotation (new Vector3 (26.3f, -40f, 0f)).CameraStartSize (0.01f).LevelStart ();
